...
notification-admin-chat-muted = { $admin } muted { $player } in chat.
notification-admin-chat-unmuted = { $admin } unmuted { $player } in chat.
notification-you-are-chat-muted = You are muted and cannot send chat messages.
notification-admin-chat-mute = Only admins can mute players.
notification-chat-mute-none = No player with that ID.
notification-chat-mute-self = The host cannot mute themselves.
