...
namespace OpenRA.Mods.Common.Traits
{
	...
	{
		public override object Create(ActorInitializer init) { return new RejectsMoveToAttack(init.Self, this); }
	}

	public class RejectsMoveToAttack : ConditionalTrait<RejectsMoveToAttackInfo>
	{
		public RejectsMoveToAttack(Actor self, RejectsMoveToAttackInfo info)
			: base(info) { }
	}
}
