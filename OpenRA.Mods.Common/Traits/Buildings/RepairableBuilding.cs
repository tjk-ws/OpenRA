...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class RepairableBuildingInfo : ConditionalTraitInfo, Requires<IHealthInfo>
	{
		...
		[Desc("Damage type used for the repair.")]
		public readonly BitSet<DamageType> RepairDamageType = default(BitSet<DamageType>);
	...
	public class RepairableBuilding : ConditionalTrait<RepairableBuildingInfo>, ITick
	{
		...
		void ITick.Tick(Actor self)
		{
			...
			if (remainingTicks == 0)
			{
				...
				self.InflictDamage(self, new Damage(-(hpToRepair * Info.RepairBonuses[activePlayers - 1] / 100), Info.RepairDamageType));
