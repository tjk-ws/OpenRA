...
WHITELISTED_OPENRA_ASSEMBLIES = OpenRA.Game.exe OpenRA.Utility.exe OpenRA.Platforms.Default.dll OpenRA.Mods.AS.dll OpenRA.Mods.Common.dll OpenRA.Mods.Cnc.dll OpenRA.Mods.D2k.dll OpenRA.Game.dll
...
install-common-mod-files:
	...
	@$(INSTALL_PROGRAM) mods/as/OpenRA.Mods.AS.dll "$(DATA_INSTALL_DIR)/mods/as"
